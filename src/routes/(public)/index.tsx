...
export const head: DocumentHead = {
  ...
  meta: [
    {
      name: 'description',
      content: 'Onucall crea agentes de voz IA que atienden llamadas 24/7, agendan citas y resuelven consultas para tu negocio. Concesionarios, inmobiliarias, clínicas y más.',
    },
    {
      property: 'og:title',
    ...
    },
    {
      ...
      content: 'Automatiza tu atención telefónica con inteligencia artificial. Sin horarios, sin límites.',
    },
  ],
};
